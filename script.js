...
for(i in clothing){
  ...
  mainCard.style.cssText = "display: flex; flex-direction: column; width: 200px; box-shadow: 0px 0px 7px rgb(170, 170, 170);"

  mainCard.addEventListener('pointerover', ()=>{
    mainCard.style.cssText = "display: flex; flex-direction: column; width: 200px; flex-wrap: wrap; box-shadow: 0px 0px 8px rgb(100, 100, 100); cursor: pointer;"
  })

  mainCard.addEventListener('pointerout', ()=>{
    mainCard.style.cssText = "display: flex; flex-direction: column; width: 200px; flex-wrap: wrap; box-shadow: 0px 0px 7px rgb(170, 170, 170);"
  })
...
console.log(accessories[i].name)
  ...
  mainCard.addEventListener('pointerover', ()=>{
    mainCard.style.cssText = "display: flex; flex-direction: column; width: 200px; box-shadow: 0px 0px 7px rgb(100, 100, 100); cursor: pointer"
  })
...
function mediaFunction(){
  if(x.matches){
    cardClothe.style.cssText = "display: grid; grid-template-columns: auto auto; grid-column-gap: 20px; grid-row-gap: 20px; flex-wrap: wrap; margin: 20px 20px 20px 0px"
    cardAccess.style.cssText = "display: grid; grid-template-columns: auto auto; grid-column-gap: 20px; grid-row-gap: 20px; flex-wrap: wrap; margin: 20px 20px 20px 0px"
  } else {
    cardClothe.style.cssText = "display: grid; grid-template-columns: auto auto auto auto auto; grid-column-gap: 20px; grid-row-gap: 20px; flex-wrap: wrap; margin: 30px 50px"
    cardAccess.style.cssText = "display: grid; grid-template-columns: auto auto auto auto auto; grid-column-gap: 20px; grid-row-gap: 20px; flex-wrap: wrap; margin: 30px 50px"
  }
}
